  ...
  <?php
    if ($_SESSION["fadeAlertCount"] === 0): ?>
      <div class="form-signin">
        <div id="successLogin" class="alert alert-success">Olet kirjautunut onnistuneesti sisään käyttäjänä <strong><?php echo $_SESSION['username'] ?></strong>!</div>
      </div>
...
<nav class="navbar navbar-inverse" id="navbar">
  <div class="container-fluid">
    <a href="login/logout.php" id="logoutButton" class="btn btn-default btn-lg btn-square " >Ulos</a>
...
<body>
  ...
  <footer class="container-fluid text-center" >
    <div id="footerText">Copyright @ 2017 Anttu Suhonen | Linkit <a target="_blank"  href="https://github.com/anttus/" >GitHubiin</a> ja
      <a target="_blank"  href="https://www.linkedin.com/in/anttu-suhonen/" >LinkedIniin</a></div>
  </footer>

  <?php if ($_SESSION["username"] === "Haukotus"): ?>
  <script>play();</script>
  <audio id="audio" src="img/tiskaan.mp3" loop="loop"></audio>
  <?php else: ?>
  <?php endif; ?>
